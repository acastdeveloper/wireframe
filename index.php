    ...
    <div id="beltnav">
        <article>
            <section>
                ...
                <h4>Blurred lines?</h4><br>The creativity <br>of code / <br>the logic <br>of design. <br><a
                    href="#">Read more...</a>
            </section>
        </article>
        <article>
        ...
        <article>
            <section>
                ...
                <h4>Be like Feynman</h4><br>Let me tell you <br>my secret: <br>I learn more <br>by teaching. <br><a
                    href="#">Read more...</a>
            </section>
        </article>
    </div>
                ...
                <article id="art-decissions">
                    ...
                    <div>
                        ...
                        <section>Gestalt theory came to systematize the whole process of our perception. But today, with
                            ...
                            knew about it. </section><a href="#">Read more...</a>
                    </div>
                </article>
                ...
                <article id="art-poo">
                    ...
                    <div>
                        ...
                        <section>Based on reallity programming languages try to recreate relationships between objects
                            and parts of them.</section><a href="#">Read more...</a>
                    </div>
                </article>
            </section>
        </main><?php
